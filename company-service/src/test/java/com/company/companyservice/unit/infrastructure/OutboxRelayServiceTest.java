package com.company.companyservice.unit.infrastructure;
...
import com.company.companyservice.stubs.InMemoryOutboxEventEntityRepository;
import com.company.companyservice.stubs.InMemoryOutboxKafkaSender;
...
class OutboxRelayServiceTest {
    ...
    void processOne_sendsMessageAndMarksPublished() throws Exception {
        ...
        assertThat(sent.topic()).isEqualTo("company-events");
    ...
    void processOne_skipsAlreadyPublishedEntry() {
        OutboxEventEntity published = new OutboxEventEntity(
                UUID.randomUUID(), UUID.randomUUID(), "CompanyCreatedEvent",
    ...
    private OutboxEventEntity pendingEntry() {
        return new OutboxEventEntity(
                ...
                "CompanyCreatedEvent",
                "company-events",
                "{\"eventId\":\"abc\",\"eventType\":\"CompanyCreatedEvent\"}",
                "PENDING",
                Instant.now(),
                null
        );
