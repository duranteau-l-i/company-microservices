package com.company.officerservice.unit.infrastructure;
...
import com.company.officerservice.stubs.InMemoryOutboxEventEntityRepository;
import com.company.officerservice.stubs.InMemoryOutboxKafkaSender;
...
class OutboxRelayServiceTest {
    ...
    void processOne_sendsMessageAndMarksPublished() throws Exception {
        ...
        assertThat(sent.topic()).isEqualTo("officer-events");
    ...
    void processOne_skipsAlreadyPublishedEntry() {
        OutboxEventEntity published = new OutboxEventEntity(
                UUID.randomUUID(), UUID.randomUUID(), "OfficerCreatedEvent",
    ...
    private OutboxEventEntity pendingEntry() {
        return new OutboxEventEntity(
                ...
                "OfficerCreatedEvent",
                "officer-events",
                "{\"eventId\":\"abc\",\"eventType\":\"OfficerCreatedEvent\"}",
                "PENDING",
                Instant.now(),
                null
        );
